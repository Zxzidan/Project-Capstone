...
root = r"C:\Users\Dandi"
ignore_patterns = [
    "AppData", "node_modules", "Microsoft", "Package Cache", ".git", 
    "Local Settings", "Templates", "System Volume Information", "$RECYCLE.BIN",
    ".vscode", ".gradle", "venv", ".virtualenv", ".rustup", ".cargo", "site-packages"
]

print(f"Scanning {root} for target files (filtered)...")
found = []
try:
